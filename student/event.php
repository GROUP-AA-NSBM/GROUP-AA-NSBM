    ...
    <?php if (!isLoggedIn()): ?>
      <div class="registration" style="padding: 24px; background: #f8fafc; border: 1px solid #d1d5db; border-radius: 12px; margin-bottom: 24px;">
        <center>
          ...
          <a href="<?php echo BASE_URL; ?>/auth/login.php" class="btn btn-primary btn-sm" style="padding: 0 24px;">Log In to Register</a>
          <p style="font-size: 0.8rem; color: #111827; margin-top: 10px;">
            ...
            Don't have an account? <a href="<?php echo BASE_URL; ?>/auth/register.php" style="color: #39B54A; text-decoration: underline; font-weight: 600;">Create one here</a>
          </p>
        </center>
      </div>
    <?php elseif (!$already_registered): ?>
